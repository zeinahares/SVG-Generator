...
function generateSVG(data) {
    ...
    if (data.shape === "Triangle") {
        ...
        text_SVGString = `<text x="150" y="160" font-size="70" text-anchor="middle" fill="${data.letters_color}">`;
        ...
        text_SVGString = `<text x="150" y="135" font-size="100" text-anchor="middle" fill="${data.letters_color}">`;
        ...
        text_SVGString = `<text x="110" y="140" font-size="100" text-anchor="middle" fill="${data.letters_color}">`;
    }
